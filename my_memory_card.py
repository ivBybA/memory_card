...
question_list.append(Question('Сколько лет Москве?"', '875', '1000', '457', '678'))
question_list.append(Question('Столица Италии?"', 'Рим', 'Москва', 'Венеция', 'Милан'))
question_list.append(Question('Когда появился первый айфон?"', '2007', '2002', '2010', '2004'))
question_list.append(Question('Сколько планет в солнечной системе?"', '8', '7', '9', '10'))
question_list.append(Question('Сколько частей в фильме Гарри Поттер?"', '8', '7', '6', '9'))
question_list.append(Question('Сколько башен у московского кремля?"', '20', '22', '18', '15'))
...
def next_question():
    if len(question_list) > 0:
        ...
        print('Статистика:\nВсего вопросов:', window.total, '\nПравильных ответов:', window.score,'\nРейтинг:', int(window.score/window.total*100)) 
        app.exit()
